...
if(isset($_SESSION['IS_AUTHENTICATED']) && $_SESSION['IS_AUTHENTICATED'] == 1){ 
	...
	echo "
<header padding>
	<h2 align='center'> - Enter patient Details - </h2> 	
</header>
	<nav>
...
<form name='myloginForm' method='post' action='med_newinsert.php'> 
<table width='35%' height='35%'  align='center' cellpadding='5' cellspacing='0'> 
<tr> 
<td style='color:rgb(6,59,118)'><center><b>Code</b></center></td> 
...
<tr> 
<td style='color:rgb(6,59,118) '><center><b>Price</b></center></td> 
<td><center> <input name='price' type='text' id='price' /></center></td> 
</tr>
</table> 
<div id = 'submit'>
